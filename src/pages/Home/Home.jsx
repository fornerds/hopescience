...
const reviews = [
  ...
  바쁜 일정 속에서도 단기간에 수료할 수 있어서 큰 도움이 되었습니다 강추드려요.`,
  },
  {
    name: "박○연",
    rating: 4.5,
...
const faqData = [
  ...
  {
    question: "강의 진도율 체크: 강의 진도율은 어떻게 측정되나요?",
    answer:
      "총 시청 시간이 영상 길이의 90% 이상이면 해당 강의를 완료했다고 체크합니다. 그러나 현재 시청위치에서 앞으로 가거나 뒤로가는 경우, 중복된 시간은 측정되지 않고, 생략된 시청구간의 영상 길이도 측정되지 않도록 계산됩니다.",
  },
  {
